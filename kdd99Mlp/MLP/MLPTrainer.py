...
class Trainer:
    ...
    def train(self, training_set, training_target):
        ...
        joblib.dump(clf, '/Users/university/learningBoardly/scientificResearch/RSpartII/KDD99/codeOutput/mlp/MLP.pkl')

    def feature_selection(self, data_set, feature_set):
        """
